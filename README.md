...
<table width="100%">
  <tr>
    ...
    <td colspan="2"><b><i>About:</i></b> ERA5 Weekly Mean 2m Temperature 1979-2000. Shows the climatology of air temperature 2 meters above the surface. Each date marks the start of the week being averaged.</td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    ...
    <td colspan="2"><b><i>About:</i></b> ERA5 Weekly Mean Sea Level Pressure 1979-2000. Shows the climatology of atmospheric pressure adjusted to sea level. Each date marks the start of the week being averaged.</td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    ...
    <td colspan="2"><b><i>About:</i></b> ERA5 Weekly Mean Surface Wind Speed at 10m 1979-2000. Shows the climatology of wind speed with static arrows showing mean wind direction. Each date marks the start of the week being averaged.</td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    ...
    <td colspan="2"><b><i>About:</i></b> ERA5 Weekly Mean Precipitable Water 1979-2000. Shows the climatology of total column water vapour. Each date marks the start of the week being averaged.</td>
  </tr>
</table>