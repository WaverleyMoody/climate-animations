...
#
# R translation of 2m_temp_nicolosi.py
# Full 48-frame double-hemisphere Nicolosi Globular animation for 2m
# temperature.
...
data_file <- paste0(
  ...
  "climate_data_by_variable/2m_temp_climatology.nc"
)
