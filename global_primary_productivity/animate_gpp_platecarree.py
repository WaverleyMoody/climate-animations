...
Script: animate_gpp_platecarree.py
Description: Generates the Gross Primary Productivity climatology
    animation from MOD17A2HGF (2000-2009), rendered in the Plate Carrée
    projection.
Note: For other projections, see the other scripts in the gpp scripts
    folder (not yet built). Data excludes 2000-01-01 through 2000-02-10
...
OUTPUT_PATH = "/Volumes/CLIMATEDATA/gpp_2000_2009_platecarree.mp4"
