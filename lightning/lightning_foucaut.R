...
#data (2010-2025), rendered in the Foucaut projection. 365 calendar-day frames 
# (Feb 29 excluded), each the multi-year daily-climatological mean, annualized 
# (x365) to match the reference product's strokes km-2 yr-1 units.
#
# Note: For the Plate Carrée, Robinson, and Nicolosi projections, see the other scripts 
