...
#
# R translation of animate_wind.py
# Generates the 10m surface wind speed climatology animation from ERA5
# reanalysis data (1979-2000), with mean wind vectors overlaid, rendered
...
for (proj_name in names(projections)) {
  ...
  video_name <- if (proj_name == "platecarree") {
    "wind_climatology.mp4"
  } else {
    sprintf("wind_climatology_%s.mp4", proj_name)
  }
