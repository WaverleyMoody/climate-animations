...
#
# R translation of animate_SLP.py
# Generates the sea level pressure climatology animation from ERA5
# reanalysis data (1979-2000), rendered across multiple map projections.
...
for (proj_name in names(projections)) {
  ...
  video_name <- if (proj_name == "platecarree") {
    ...
    sprintf("slp_climatology_%s.mp4", proj_name)
  }
